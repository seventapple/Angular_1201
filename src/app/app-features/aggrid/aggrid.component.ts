...
export class AggridComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.columnDefs = [
      ...
      //三层 表格显示- 表格底层处理- 实际值
      {headerName: 'Form', field: 'formId', valueFormatter: this.filterForm.bind(this)},
      {headerName: 'Xml', field: 'xmlName'},
      //此列不设置为搜索用
      {
        headerName: 'Price', field: 'price', getQuickFilterText: params => ''
      },
      {
    ...
    //表格数据
    this.rowData = [
      {formId: '123567_FormA', xmlName: 'a.xml', price: 35000, comment: 'Aa'},
      {formId: '567890_FormA', xmlName: 'b.xml', price: 32000, comment: 'Ab'},
      {formId: '684253_FormA', xmlName: 'c.xml', price: 72000, comment: 'Ac'},
      {formId: '567890_FormB', xmlName: 'a2.xml', price: 72000},
      {formId: '554422_FormB', xmlName: 'c2.xml', price: 72000},
      {formId: '127890_FormC', xmlName: 'a3.xml', price: 72000},
